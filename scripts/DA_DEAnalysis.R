...
if(tolower(dispersionsVal) == "common" ||
   tolower(dispersionsVal) == "trended" ||
   tolower(dispersionsVal) == "tagwise" ||
   tolower(dispersionsVal) == "auto" ||
   tolower(dispersionsVal) == "null"){ # case insensitive check string inputs
